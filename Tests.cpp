...
void Tests::testIO() {
    ...
    Movie aux;
    ofstream fout("/home/octav/CLionProjects/LAB9OOP/testIO/out");
    ifstream fin("/home/octav/CLionProjects/LAB9OOP/testIO/in");
...
void Tests::testRepoFile() {
    MovieRepositoryFile repo = MovieRepositoryFile("/home/octav/CLionProjects/LAB9OOP/IORepoTests/test");
    Movie movie1 = Movie("1", "1", 1, "1");
    Movie movie2 = Movie("2", "2", 2, "2");
    Movie movie3 = Movie("1", "3", 3, "3");
    repo.add(movie1);
